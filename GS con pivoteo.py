...
print("Soluciones cambiando Filas: ", GS_NP(A_np, b_np, 100000, 0.00001))
...
#Para imprimir valores:
print("Soluciones cambiando Columnas: ", GS_NP(A_np, b_np, 100000, 0.00001))
